      ...
      <ScrollView showsVerticalScrollIndicator={false} >
        <View style={styles.backgroundContainer}>
          ...
          <View style={styles.timeIcons}>
            <Ionicons style={{marginRight: 25, marginBottom: 230}} name="time-outline" size={35} color="white" />
            <View style={styles.column}>
              <Text style={{color: "white", marginRight: 10, marginBottom: 0}}>{hours}:{minutes}</Text>
              <Text style={{color: "white", marginRight: 10, marginBottom: 0}}>{month}/{day}/{year}</Text>
            </View>
          </View>
