         ...
         <View style={styles.aboutMeContainer}>
            ...
            <Text style={styles.title}>a Software Developer building mobile apps and websites</Text>
               <Text style={styles.chicago}>
                    Chicago, IL
                  <FontAwesome style={{position: "relative", top: -22, left: 24}} name="map-pin" size={14} color="white" />
                  <Fontisto  style={{position: "relative", top: -5, right: 5}} name="world-o" size={24} color="white" /> 
               </Text>
         </View>
        </ScrollView>
      </>
