        ...
        <Pressable  style={{padding: 20}} onPress={() => router.back()}>
         ...
         <View numberOfLines={0} style={styles.aboutMeContainer}>
            ...
            <Text style={styles.content}>I'm currently developing projects using JavaScript libraries and frameworks like React and React Native, while learing more about native 
              iOS and Android development, specifically Kotlin and Swift programming. What I enjoy the most about mobile development is UI design📱, and seeing my designs instantly come to life on the screen is fun. 
