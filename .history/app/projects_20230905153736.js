                  ...
                  <View style={styles.box}>
                    {item.image.includes('<iframe') ? (
                      ...
                      <>
                        ...
                        {/* <Link href="item.githubLink" asChild> */}
                          <Pressable onPress={() => router.push({params: {id: item.id, link: item.githubLink}})} style={styles.githubButton}>
                            <FontAwesome style={styles.icon} name="github" size={30} color="black" />
                          </Pressable>
                        {/* </Link> */}
