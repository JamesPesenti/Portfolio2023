         ...
         <View style={styles.aboutMeContainer}>
            ...
            <Text style={styles.title}>a Software Developer building mobile apps and websites</Text>
               <Text style={styles.chicago}>
                   in Chicago, IL.  
                  <FontAwesome style={{position: "relative", top: -22, left: 25}} name="map-pin" size={13} color="white" />
                  <Fontisto  style={{position: "relative", top: -5, right: 5}} name="world-o" size={20} color="white" /> 
               </Text>
         </View>
        </ScrollView>
      </>
