         ...
         <View style={styles.aboutMeContainer}>
            ...
            <Text style={styles.title}>a Software Developer building mobile apps </Text>
               <Text style={styles.chicago}>
                  ...
                  <FontAwesome style={{position: "relative", top: -22, left: 27}} name="map-pin" size={13} color="white" />
                  <Fontisto  style={{position: "relative", top: -20, right: 20}} name="world-o" size={20} color="white" /> 
               </Text>
         </View>
        </ScrollView>
      </>
