      ...
      <View>
        <Pressable  style={{padding: 20}} onPress={() => router.back()}>
         ...
         <View numberOfLines={0} style={styles.aboutMeContainer}>
            ...
            <Text style={styles.content}>I'm currently developing projects with JavaScript frameworks like React and React Native while learing more about native IOS and Android development. What truly fuels my passion is mobile app development, especially UI design📱. I get satisfaction in seeing my designs come to life on the screen. Recently, I contributed as a junior developer to a retail tech startup, where I played a crucial role in implementing updates to their website and creating new UI components. Beyond coding, I enjoy fitness, travel, and cooking Italian cuisine.</Text>
         </View>
    </>
  )
}
