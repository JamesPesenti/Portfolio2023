      ...
      <ScrollView showsVerticalScrollIndicator={false} >
        <View style={styles.backgroundContainer}>
          ...
          <View style={styles.timeIcons}>
            <Ionicons style={{marginRight: 0, marginBottom: "auto"}} name="time-outline" size={35} color="white" />
            <Text style={{color: "white", marginRight: 10, marginBottom: 90}}>{hours}:{minutes}</Text>
            <Text style={{color: "white", marginRight: 10, marginBottom: 90}}>{month}/{day}/{year}</Text>
          </View>
