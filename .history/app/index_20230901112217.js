      ...
      <ScrollView showsVerticalScrollIndicator={false} >
        <View style={styles.backgroundContainer}>
          ...
          <View style={styles.trash}>
            ...
            <Ionicons style={{marginRight: 30, marginBottom: 60}} name="ios-folder-outline" size={155} color="white" />
            <Ionicons style={{marginRight: "auto"}} name="time-outline" size={35} color="black" />
          </View>
