...
export default function App() {
  ...
  const year = currentDate.getMinutes()
      ...
      <ScrollView showsVerticalScrollIndicator={false} >
        <View style={styles.backgroundContainer}>
          ...
          <View style={styles.desktopIcons}>
            <Ionicons style={{marginRight: 0, marginBottom: 20}} name="time-outline" size={35} color="white" />
          ...
          <View style={styles.desktopIcons}>
            <Text style={{marginRight: 10, marginBottom: 200}}>{hours}:{minutes}</Text>
            <Text style={{marginRight: 10, marginBottom: 200}}>{month}/{day}/{year}</Text>
          </View>
